...
3. B树查找效率与键在B树中的位置相关；B+树复杂度对某个建成的树是固定的
...
## B+树网络
![B+树结构](pic/Innodb%E7%B4%A2%E5%BC%95%E5%8E%9F%E7%90%861.png)
...
#### 页面结构管理
页面结构如图
![页面结构](pic/Innodb%E7%B4%A2%E5%BC%95%E5%8E%9F%E7%90%862.png)
...
- 槽本身是排序的，放在页面的最后的位置，槽的长度与页面内存储的记录数有关系
