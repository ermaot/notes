...
3. 备库 读取中继日志中的事件，重放到备库数据库上。==可以配置中继日志是否写入自己的二进制日志中。==
  ![复制拓扑](pic/MySQL%E5%A4%8D%E5%88%B6.png)

  ![img](pic/MySQL复制/v2-7799335ac25ba5114c9d6e1fec1a4aca_720w.jpg)
...
![image](pic/MySQL%E5%A4%8D%E5%88%B62.png)
#### 复制过滤器
...
![主主复制](pic/MySQL%E5%A4%8D%E5%88%B63.png)
...
#### 拥有备库的主主结构
#### 环形复制
![image](pic/MySQL%E5%A4%8D%E5%88%B64.png)
...
- 可以使用分发主库（实际是专用备库）
![image](pic/MySQL%E5%A4%8D%E5%88%B65.png)


#### 树或者金字塔形
![image](pic/MySQL%E5%A4%8D%E5%88%B66.png)
#### 定制的复制方案
## 复制和容量规划
#### 为什么复制无法扩展写操作
#### 备库什么时候开始延迟
